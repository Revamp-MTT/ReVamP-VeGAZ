...
def DoS(ip, port, size, count, index):
...
def main():
    try:
        ...
        if COUNT > 65500 or COUNT < 1:
            print("\n\033[1;31m[ERROR] \033[0m\xBB Please, choose a count between 1 and 65500")
            sys.exit(1)

        if IP > 65500 or IP < 1:
            print("\n\033[1;31m[ERROR] \033[0m\xBB Please, choose a ip between 1 and 65500")
            sys.exit(1)
